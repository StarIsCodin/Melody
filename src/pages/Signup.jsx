...
function Signup() {
  ...
  const isValidateEmail = async (email) => {
    ...
    try {
        const response = await axios.get(`https://melody-api-lh84.onrender.com/api/users/check-email?email=${email}`);
  ...
  const handleGoogleLogin = async (response) => {
      try {
          ...
          const checkEmailResponse = await axios.get(`https://melody-api-lh84.onrender.com/api/users/check-email?email=${email}`);

          if (checkEmailResponse.data.exists) {
              // Email đã tồn tại => Đăng nhập bình thường
              const loginResponse = await axios.post("https://melody-api-lh84.onrender.com/api/users/google-login", { email });
              ...
              const registerResponse = await axios.post("https://melody-api-lh84.onrender.com/api/users/", {
                  email,
                  name,
                  gender: "Nam",
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateStep()) {
        try {
            ...
            const response = await axios.post("https://melody-api-lh84.onrender.com/api/users", userData);
